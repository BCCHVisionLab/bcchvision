...
{% include figure.html image="images/conference-Akosua_BB&D.jpg" caption="Akosua at Research Day (2022), BC Children’s Hospital, Brain, Behaviour, & Development Theme"%}

{% endcapture %}

{% capture col2 %}

{% include figure.html image="images/conference-Zahra_BB&D.jpg" caption="Zahra at Research Day (2022), BC Children’s Hospital, Brain, Behaviour, & Development Theme" %}

{% endcapture %}

{% capture col3 %}

{% include figure.html image="images/conference-Alex_BB&D.jpg" caption="Alex at Research Day (2022), BC Children’s Hospital, Brain, Behaviour, & Development Theme" %}
...
{% include figure.html image="social-GiaschiLab2021.jpg" %}

{% endcapture %}

{% capture col2 %}

{% include figure.html image="social-Lab Bowling" caption="Pictures from our lab bowling social! (2023)" %}
...
{% capture col2 %}
{% include figure.html image="images/social-Skiing 2.jpeg" %}
{% endcapture %}

{% include cols.html col1=col1 col2=col2%}

{% capture col3 %}
{% include figure.html image="images/social-Skiing 1.jpeg" %}
{% endcapture %}
